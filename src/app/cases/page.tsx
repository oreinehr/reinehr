...
const cases: Case[] = [
  ...
  { id: 2, src: "/luci.png", alt: "Case 2", category: "Branding", title: "Portfolio Website", description: "Portolio Website for Luciano." },
        ...
        <div className="flex gap-3 mb-12">
          {["All", "Branding", "Motion", "Website"].map((cat) => (
            <button
              key={cat}
              onClick={() =>
                setSelectedCategory(cat as "All" | "Branding" | "Motion" | "Website")
              }
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-6">
  {filteredCases.map((c) => (
    ...
    >
      ...
      />
      {/* Overlay */}
      <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition duration-500 flex items-end p-4">
